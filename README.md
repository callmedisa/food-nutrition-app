...
Проект для диссертации: мобильное приложение для распознавания еды по фотографии и определения БЖУ (белки, жиры, углеводы) и калорийности.
...
Проект разработан для диссертации (2026)
